 ...
 *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
var UncosNews = function(config) {
    config = config || {};
    UncosNews.superclass.constructor.call(this,config);
};
Ext.extend(UncosNews,Ext.Component,{
    page:{},window:{},grid:{},tree:{},panel:{},combo:{},config: {}
});
Ext.reg('uncosnews',UncosNews);
UncosNews = new UncosNews();