...
Ext.onReady(function() {
    MODx.load({ xtype: 'uncosnews-page-home'});
});
 
UncosNews.page.Home = function(config) {
    config = config || {};
		Ext.get('modAB').update(UncosNews.config.copyright);
    Ext.applyIf(config,{
        components: [{
            xtype: 'uncosnews-panel-home'
            ,renderTo: 'uncosnews-panel-home-div'
        }]
    });
    UncosNews.page.Home.superclass.constructor.call(this,config);
};
Ext.extend(UncosNews.page.Home,MODx.Component);
Ext.reg('uncosnews-page-home',UncosNews.page.Home);