...
/* get news */
if (empty($scriptProperties['id'])) return $modx->error->failure($modx->lexicon('uncosnews.err_ns'));
$newsItem = $modx->getObject('UncosNewsNews',$scriptProperties['id']);
...
$scriptProperties['editedby'] = $modx->user->get('id');
